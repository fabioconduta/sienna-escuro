    ...
    <div className="min-h-screen bg-sienna-950 text-sienna-100 font-sans overflow-x-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 px-6 py-8 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-12 text-sm tracking-widest uppercase text-sienna-100/70">
          ...
          <a href="#method" className="hover:text-sienna-50 transition-colors">Metodo</a>
        </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-tight mb-8 text-sienna-50">
              Refinamento<br />
              <span className="italic font-light text-sienna-300">contemporaneo</span><br />
              para sua essencia.
            </h1>
            <p className="text-lg text-sienna-100/70 mb-10 font-light leading-relaxed max-w-md">
              Um espaco dedicado ao cuidado autentico, onde a sofisticacao encontra o acolhimento para revelar a sua melhor versao.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-sienna-100/70 font-light leading-relaxed">
              <p>
                Acredito que a verdadeira beleza nasce do equilibrio e do cuidado intencional.
              </p>
              <p>
                Com mais de uma decada de experiencia, desenvolvi uma abordagem que une tecnicas avancadas a um olhar profundamente humano e acolhedor.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section id="services" className="py-24 md:py-32 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          {[
            {
              title: "Estetica Avancada",
              desc: "Protocolos faciais e corporais personalizados.",
            ...
            },
            {
              ...
              desc: "Momentos de pausa e reconexao atraves de massagens e rituais.",
              img: "https://images.unsplash.com/photo-1544161615-4ab6ced6b874?q=80&w=800&auto=format&fit=crop"
            },
            {
              title: "Mentoria Pessoal",
              desc: "Acompanhamento proximo para desenvolvimento pessoal.",
            ...
            >
              ...
              <h3 className="font-serif text-2xl mb-4 text-sienna-50">{service.title}</h3>
              <p className="text-sienna-100/70 font-light leading-relaxed mb-6">{service.desc}</p>
              <span className="inline-flex items-center text-sm tracking-wider uppercase text-sienna-400">
                Descobrir <ArrowRight size={14} className="ml-2" />
              </span>
            </motion.div>
          ))}
        </div>
      ...
      <section id="method" className="py-24 md:py-32 bg-sienna-800 px-6 md:px-12 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="font-serif text-3xl md:text-5xl leading-tight text-sienna-50 mb-10">
            O verdadeiro luxo e ter tempo para si mesma. Meu metodo nao busca a perfeicao, mas sim a{' '}
            <span className="italic text-sienna-300">harmonia absoluta</span>
            {' '}entre como voce se sente e como voce se apresenta ao mundo.
          </h2>
          <p className="tracking-widest uppercase text-xs text-sienna-400 font-medium">
            O Metodo Sienna
          </p>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-sienna-900 px-6 md:px-12 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-sienna-100/70 mb-12 font-light leading-relaxed">
            Agende uma avaliacao e descubra um plano de cuidado desenhado exclusivamente para as suas necessidades.
          </p>
          <button className="bg-sienna-100 text-sienna-950 px-10 py-5 rounded-full hover:bg-sienna-200 transition-all duration-300 text-sm tracking-widest uppercase font-medium">
            Agendar meu momento
          </button>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 md:gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-sienna-100/60 font-light max-w-sm mb-8 leading-relaxed">
              Refinamento contemporaneo e cuidado autentico para revelar a sua melhor versao.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sienna-100/60 font-light">
              <li className="flex items-start space-x-3">
                ...
                <span>Rua das Flores, 123, Sao Paulo - SP</span>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sienna-100/60 font-light">
              ...
              <li><a href="#method" className="hover:text-sienna-100 transition-colors">O Metodo</a></li>
            </ul>
          </div>
        </div>
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-sienna-100/10 text-center text-sm text-sienna-100/40 font-light">
